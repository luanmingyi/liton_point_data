	...
	namespace D1
	{
		...
		class PointData
		{
		  ...
		  public:
			...
			inline _NUMT &operator()(const int &i, const unsigned &n, const F0 &flag0)
			{
				check_n(n);
				check_flag(flag0);
				_size.check_range(i);
			...
			template<typename F0>
			inline const _NUMT &operator()(const int &i, const unsigned &n, const F0 &flag0) const { return *this(i, n, flag0); }
